...
if (strcmp(settings.dataType, 'schar')) 
format='int8';
else
format='int16'
end

m = memmapfile(settings.fileName, 'Format', format);
...
StartIndex = dataAdaptCoeff*settings.skipNumberOfBytes;
...
[trkResults] = run_tracking_cmex(m, channel, settings);
